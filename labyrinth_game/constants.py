...
ROOMS = {
    ...
    'garden': {
        'description': (
            'Затененный сад с мраморными статуями. Лестница ведет куда-то вниз.'
        ),
        'exits': {'west': 'armory', 'down': 'secret_chamber'},
        'items': ['golden_apple'],
        'puzzle': {
            'question': 'Сколько предметов лежит в саду?',
            'answer': '1'
        }
    },
    'secret_chamber': {
        'description': (
            'Тайная комната под садом. Здесь хранится древний артефакт.'
        ),
        'exits': {'up': 'garden'},
        'items': ['ancient_artifact'],
        'puzzle': {
            'question': 'Назовите слово, которое означает "начало всего"',
            'answer': 'альфа'
        }
    }
}
